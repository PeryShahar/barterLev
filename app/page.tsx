  ...
  return (
    <>
      ...
      <div className="how-it-works-section mt-2 font-single p-10">
        <h4 className="text-center text-6xl text-rose-400 tracking-wider pt-48">How BarterLev works</h4>
        <section id="how-it-works" className="py-16 text-black">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center">
                <Image src={'/sign-up.png'} width={200} height={200} alt="sign-up" />
              ...
              <div className="flex flex-col items-center">
                <Image src={'/magnifying-glasses.png'} width={200} height={200} alt="magnifying-glasses" />
              ...
              <div className="flex flex-col items-center">
                <Image src={'/shaking-hands.png'} width={200} height={200} alt="shaking-hands" />
