/*
  ...
  - You are about to drop the column `give` on the `User` table. All the data in the column will be lost.
  - You are about to drop the column `receive` on the `User` table. All the data in the column will be lost.
